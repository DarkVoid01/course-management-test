              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    A comprehensive platform for instructors to create courses and students to learn at their own pace.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Everything you need to manage your courses and enhance the learning experience.
                </p>
              </div>
            </div>
...
const features = [
  {
    ...
    icon: function BookIcon(props: React.SVGProps<SVGSVGElement>) {
      return (
        <svg
          {...props}
  ...
  },
  {
    ...
    icon: function FileIcon(props: React.SVGProps<SVGSVGElement>) {
      return (
        <svg
          {...props}
          xmlns="http://www.w3.org/2000/svg"
